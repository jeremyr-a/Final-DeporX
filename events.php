...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        $conn->query($query)or die('<script type="text/javascript">alert("Horario No Disponible ")</script>');
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Amistosos</option>
                        <option value="event-success">Futbol-sala</option>
                        <option value="event-important">Mini-Torneo</option>
                        <option value="event-warning">Torneo</option>
                        <option value="event-special">Mixto</option>
                    </select>
